...
export const NavBare = () => {
  const [active,setActive]=useState(false)
    return (
      <nav class="navbar navbar-expand-lg bg-light box-shadow bg-white">
        <div class="container p-2 ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 move">
              <li class="nav-item dropdown ">
                ...
                <ul class="dropdown-menu box ">
                  <li className="">
                    <a class="dropdown-item d-flex gap-3 gray" href="/">
                      <svg
                        width="14"
                        height="16"
            ...
            <button
              class="btn fw-500 btn-outline-dark me-2 grayer border-none"
              type="button"
            >
              Login
            </button>
            <button class="btn btn-outline me-2 grayer" type="button">
              Register
            </button>
          </div>
        </div>
